<?php
namespace Voltage\Rank\command;
                ...
                switch ($args[0]) {
                            ...
                            if (isset($args[2])) {
                                if (Main::getProviderSysteme()->existRank($args[2])) {
                                    ...
                                    if ($player instanceof Player) {
                                        $name = $player->getName();
                                        Main::getProviderSysteme()->setRankWithUpdate($name, $args[2]);
                    ...
                    case "remove":
                        if ($sender->hasPermission("command.rank.del")) {
                            if (isset($args[1])) {
                                if (Main::getProviderSysteme()->existRank($args[1])) {
                                    Main::getProviderSysteme()->removeRankWithUpdate($args[1]);
                            ...
                            if (!empty($args[2])) {
                                if (Main::getProviderSysteme()->existRank($args[1])) {
                                    if (!Main::getProviderSysteme()->existPerm($args[1], $args[2])) {
                                        Main::getProviderSysteme()->addPermWithUpdate($args[1], $args[2]);
                    ...
                    case "removeperm":
                        if ($sender->hasPermission("command.rank.delperm")) {
                            if (!empty($args[2])) {
                                if (Main::getProviderSysteme()->existRank($args[1])) {
                                    if (Main::getProviderSysteme()->existPerm($args[1], $args[2])) {
                                        Main::getProviderSysteme()->removePermWithUpdate($args[1], $args[2]);
                        ...
                        if ($sender->hasPermission("command.rank.setprefixtag")) {
                            if (!empty($args[2])) {
                                if (Main::getProviderSysteme()->existRank($args[1])) {
                                    ...
                                    unset($args[1]);
                                    $prefix = implode(" ", $args);
                                    Main::getProviderSysteme()->setGameTagPrefixWithUpdate($rank, $prefix);
                    ...
                    case "default":
                        if ($sender->hasPermission("command.rank.default")) {
                            if (!empty($args[1])) {
                                if (Main::getProviderSysteme()->existRank($args[1])) {
                                    $rank = $args[1];
                                    Main::getProviderSysteme()->setDefaultRankWithUpdate($rank);
